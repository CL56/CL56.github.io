...
var promoText = [
            ...
            ["😇 We value you. We think you're amazing ...a bit special even. That's why you can play " + game.title + " or any of the games on Friv with no ad interruptions, ever."],
            ...
            ["😜 It's 2022 and Friv is finally on TikTok! Find us @friv ...we'd be so grateful if you would follow us and like our videos! Thank you! 😜"],
        ];


if (pageViews > 10 && Math.random() > 0.95) {
...
loadingBox.addEventListener('click', function (e) {
    ...
    if (os.indexOf("iOS") == -1 && allowFullScreen) {
        e.preventDefault();
